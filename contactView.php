...
<html lang="en">
 ...
 <!--company logo-->
    ...
    <!-- Viewing the table from the database in main class -->
    <main class="main">
        <table class="excel-table">
            ...
            <!-- including php file to connect to database for viewing -->
            <?php
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row['No_of_linked_clients'] . "</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='3'>No contacts found</td></tr>";
                echo "<tr><td colspan='3'><a href='addClients.php'><button class='btn'>Add New Contacts</button></a></td></tr>";
            }
            ?>
        </table>
    </main>
